...
欢迎您使用【2048道具版】！我们非常重视保护您的个人信息和隐私。您可以通过《【2048道具版】隐私政策》了解我们收集、使用、存储用户个人信息的情况，以及您所享有的相关权利。请您仔细阅读并充分理解相关内容：

1. 为向您提供游戏服务，我们将依据《【2048道具版】隐私政策》收集、使用、存储必要的信息。
1. 基于您的明示授权，我们可能会申请开启您的【安卓手机】设备权限，您有权拒绝或取消授权。
...
请您阅读完整版《【2048道具版】用户协议》及《【2048道具版】隐私政策》了解详细信息。

如您同意《【2048道具版】用户协议》及《【2048道具版】隐私政策》，请您点击“同意”开始使用我们的产品和服务，我们将尽全力保护您的个人信息安全。
...
【渣滓桦工作室】（以下简称“**我们**”）系移动应用程序“【2048道具版】”（以下简称“【2048道具版】”）的运营者。我们非常重视保护用户（以下简称“**您**”）的个人信息和隐私。您在使用【2048道具版】时，我们会收集、使用、保存、共享您的相关个人信息。为呈现我们处理您个人信息的情况，我们特制定《【2048道具版】隐私政策》（以下简称“**隐私政策**”），我们承诺严格按照本隐私政策处理您的个人信息。

我们在此提醒您：

**在您使用【2048道具版】前，请您务必认真阅读本隐私政策，充分理解各条款内容，包括但不限于免除或限制我们责任的条款。您知晓并确认，您勾选“同意”本隐私政策并使用【2048道具版】，就表示您同意我们按照本隐私政策处理您的个人信息。**请您知悉，本政策仅适用于我们通过【2048道具版】向您提供服务所收集的信息，不适用于通过接入【2048道具版】以向您提供产品或服务的第三方所收集的信息。
...
1. <a name="v3qnlv"></a>**我们如何收集和使用您的个人信息**

   **（一）我们如何收集您的个人信息**

   在您使用【2048道具版】过程中，我们会按照如下方式收集您的个人信息：

1. **完成注册**

当您注册【2048道具版】账户时，我们需要收集您的手机号码、登录密码。我们收集您的上述信息是为了帮助您完成【2048道具版】账户的注册，保护您的账户安全，如您不提供这类信息，我们将无法为您创建账户并正常向您提供服务。
...
当您进行实名认证时，我们需要收集您的姓名、身份证件类型、身份证件号码。同时，为实现实名认证的目的，您同意并授权我们自行或委托第三方向有关实名认证机构（如个人征信机构、政府部门等）提供、查询、核对您的前述身份信息。我们收集您的上述信息是为了履行法定义务，核验用户真实身份、识别用户年龄以及保障系统和服务安全。如您不提供这类信息，您将无法登录【2048道具版】或在使用【2048道具版】过程中受到相应限制。
...
该游戏尚处于测试阶段，无充值功能，请谨慎判断，以防上当受骗。

2. **设备权限调用情况**

   在您使用【2048道具版】过程中，我们需要在必要范围内向您申请获取设备权限。**请您知悉，我们不会默认开启您设备的权限，仅在您主动确认开启的情况下，【游戏产品名称】才有可能通过设备权限收集您的信息。**【游戏产品名称】调用的权限、调用权限的目的，以及调用权限前向您询问的情况请见下表：

|&emsp;**设备权限**|&emsp;**调用权限的目的**|&emsp;**是否询问**|&emsp;**用户可否关闭权限**|
| :-: | :-: | :-: | :-: |
|&emsp;网络|&emsp;连接网络|&emsp;是|&emsp;可|
...
1) **与我们的业务合作伙伴共享。我们可能会将您的个人信息共享【TAPTAP游戏平台】。我们共享这些信息的目的是为实现服务所必需，比如我们需要将您的【账号信息】共享给【TAPTAP游戏平台】以向您提供【数据同步】服务。**
1. **转让**
...
|&emsp;**SDK名称**|&emsp;**SDK使用目的**|&emsp;**SDK收集的信息**|&emsp;**隐私政策链接**|
| :-: | :-: | :-: | :-: |
|&emsp;Unity SDK|&emsp;提供相关游戏服务|<p>&emsp;1\.设备标识信息(硬件型号、操作系统版本、设备设置、IMEI、 MAC地址、AndroidID、 必要的软件列表等)</p><p>&emsp;2\.设备传感器信息</p>|&emsp;<https://unity.cn/legal/china-privacy-policy>|
|&emsp;TAP TAP SDK|&emsp;用迪:为了便于经调用户拍愿照片、规颜和上传、分享图片、视频信息，为了更精确地辅助开发者|<p>&emsp;&emsp;&emsp;1. 允许程序获取本地存储权限</p><p>&emsp;&emsp;&emsp;2. 允许程序获取IP地址</p><p>&emsp;&emsp;&emsp;3. 允许程序应用标识符</p><p>&emsp;&emsp;&emsp;4. 允许程序独立设备标识符</p><p>&emsp;&emsp;&emsp;5. 允许程序iOs广告标识符</p><p>&emsp;&emsp;&emsp;6. 允许程序安卓广告主标识符</p><p>&emsp;&emsp;&emsp;7. 允许程序网卡(MAC)地址</p><p>&emsp;&emsp;&emsp;8. 允许程序国际移动设备识别码(MED)</p><p>&emsp;&emsp;&emsp;9. 允许程序设备型号</p><p>&emsp;&emsp;&emsp;10. 允许程序终端制造厂商</p><p>&emsp;&emsp;&emsp;11. 允许程序终端设备操作系统版本</p><p>&emsp;&emsp;&emsp;12. 允许程序时区和网络状态(WIFI等)</p>|<https://developer.taptap.cn/docs/sdk/start/agreement/>|
...
1. **您如何管理您的个人信息**
   ...
   在您使用【2048道具版】期间，您可以通过相应页面提示或本隐私政策载明的方式联系我们，以访问、更正、删除您的个人信息，以及行使改变授权同意的范围与注销账号的权利，您的意见会及时得到处理。

1. **访问及更正您的个人信息**

如您希望访问或更正您的个人信息，您可根据我们APP内的指引，在APP内或在APP中接入的第三方服务中访问、更新您的个人信息。在访问、更新前述信息时，我们可能会要求您进行身份验证，以保障信息安全。
...
请您理解，【2048道具版】可能需要开启部分权限并收集必要的个人信息才能得以实现。当您撤回您的同意时，我们将无法继续为您提供撤回同意所对应的服务，但不会影响此前基于您的授权而开展的个人信息处理服务。

1. **注销账户**

如果您希望注销您的账户，您可根据我们APP内的指引，在APP内或在APP中接入的第三方服务中删除您的个人信息。删除前述信息时，我们可能会要求您进行身份验证，以保障信息安全。
...
1. <a name="30pmug"></a><a name="9l90eg"></a>**本隐私政策如何更新**
